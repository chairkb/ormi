...
package biz.stech.base;

import biz.stech.util.CryptoRsa;
...
public class App {
	public static final String PROPERTY_APP = "stechapp.properties";
	...
	public static final String ERROR_COMPLAIN = ", please contact: &nbsp<a href='mailto:stech@gmail.com'>stech@gmail.com</a>";
	public static final String CONTACT_US = " <a href='mailto:stech@gmail.com'>stech@gmail.com</a>";
	...
	public static String getCurrentClass() {
		...
		for (StackTraceElement eachStackElement : stack) {
			...
			if (className.contains("biz.stech")) {
				if (className.contains("biz.stech.base.app") == false && className.contains("biz.stech.base.hinderance") == false) {
					break;
				}
			}
		}
